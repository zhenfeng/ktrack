...
int main( int argc, char* argv [] )
{
  ...
  vector<string> files_jpeg;
  getFilePrefixes(argv[1],string(".jpg"),files_jpeg);
  ...
  for (int k = 0; k < (int) files_jpeg.size(); k++ )   // Main Loop
  {
    string filename = argv[1] + string("/") + files_jpeg[k] + ".jpg";
